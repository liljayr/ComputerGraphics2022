...
function funcInit() {
    ...
    var toggleJuniper = document.getElementById("toggleJuniper");
    var toggleLight = document.getElementById("toggleLight");

    // Toggle
    toggleJuniper.addEventListener("click", function(event) {
        // Do something
        render();
    });

    toggleLight.addEventListener("click", function(event) {
        // Do something
        render();
    });
}
